...
|------|------|------|
| [1] | `/rp-init` | 프로젝트 초기화 |
| [2] | `/rp-spec` | 구체화 (도메인→기술→인증) |
| [3] | `/rp-prd` | PRD 작성 |
| [4] | `/rp-plan-review` | 기획 리뷰 |
| [5] | `/rp-eng-review` | 엔지니어링 리뷰 |
| [6] | `/rp-tasks` | 태스크 분해 |
| [7] | `/rp-dev T-XX` | 개발 (태스크 단위) |
| [8] | `/rp-code-review` | 코드 리뷰 (태스크 머지 전) |
| [9] | `/rp-qa` | QA |
| [10] | `/rp-ship` | 최종 산출물 + PR |

각 스킬은 독립 실행 가능. 전제 미충족 시 이전 단계 안내.
