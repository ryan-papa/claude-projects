---
name: rp-plan-review
description: "[4] 기획 리뷰. 진입 런타임 서브에이전트가 9항목 채점. 교차 런타임 리뷰 없음. Use when Codex should run or follow the harness rp-plan-review stage, or when the user invokes /rp-plan-review, $rp-plan-review, or asks for this workflow step."
---

> Generated from `docs/skills/rp-plan-review.md`. Do not edit this file directly; run `python3 scripts/sync-codex-skills.py` after changing the Claude skill source.
