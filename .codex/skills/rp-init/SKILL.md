---
name: rp-init
description: "[1] 프로젝트 초기화. CLAUDE.md·README.md·PRD 디렉터리 등 기본 구조 생성. Use when Codex should run or follow the harness rp-init stage, or when the user invokes /rp-init, $rp-init, or asks for this workflow step."
---

> Generated from `docs/skills/rp-init.md`. Do not edit this file directly; run `rtk python3 scripts/sync-codex-skills.py` after changing the Claude skill source.
