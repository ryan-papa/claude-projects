---
name: rp-infra-review
description: "[9-인프라] 인프라 리뷰. 코드 리뷰와 병렬 실행. BLOCK/ASK/WARN 무점수 판정, 정적 분석 전용. Use when Codex should run or follow the harness rp-infra-review stage, or when the user invokes /rp-infra-review, $rp-infra-review, or asks for this workflow step."
---

> Generated from `docs/skills/rp-infra-review.md`. Do not edit this file directly; run `python3 scripts/sync-codex-skills.py` after changing the Claude skill source.
