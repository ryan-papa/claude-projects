---
name: rp-prd
description: "[3] PRD 작성. 일반 기능은 Full PRD, 하네스 메타 변경은 간소 PRD 자동 분기. Use when Codex should run or follow the harness rp-prd stage, or when the user invokes /rp-prd, $rp-prd, or asks for this workflow step."
---

> Generated from `docs/skills/rp-prd.md`. Do not edit this file directly; run `rtk python3 scripts/sync-codex-skills.py` after changing the Claude skill source.
